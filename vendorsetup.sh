...
# Custom pic for the maintainer's info in about section
	export OF_MAINTAINER_AVATAR="$PWD/device/vivo/k6853v1_64_6360/maintainer.png"
	
# Device Information.
	export FOX_ARCH=arm64
	export FOX_VARIANT="A12_FBEv1"
	export TARGET_DEVICE_ALT="k6853v1_64_6360,vivo6853,mt6853,mtk6853,PD2057" # I am not what are the over possible names.
